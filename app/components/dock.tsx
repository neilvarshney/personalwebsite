...
export function Dock() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50 w-[95vw] max-w-[500px] sm:w-auto"
    >
      <div className="bg-gray-800/90 backdrop-blur-md rounded-full px-[2vw] sm:px-4 py-[1vw] sm:py-2 flex items-center justify-center space-x-[1vw] sm:space-x-4 shadow-lg w-fit mx-auto">
        {sections.map((section) => (
          <button
            key={section.id}
            onClick={() => scrollToSection(section.id)}
            className={`px-[2vw] sm:px-4 py-[1vw] sm:py-2 rounded-full transition-all duration-200 text-[3.5vw] sm:text-base whitespace-nowrap ${
